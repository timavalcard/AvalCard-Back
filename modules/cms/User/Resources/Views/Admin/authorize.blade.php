    ...
    <x-slot name="main">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-4">
                    <div class="col-sm-6">
                        <h3 class="m-0 text-dark">        لیست درخواست های احراز هویت</h3>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="admin-page-top">
                ...
                <table class="admin-table final-table">
                    ...
                    @foreach($users as $meta)
                        @if(isset($meta->user))
                            <tr>
                        <td><a href="{{ route("admin_check_authorize",["id"=>$meta->user->id]) }}">
                                {{$meta->user->authorize_name}} {{$meta->user->authorize_last_name}}
                            </a>
                            <div class="admin-table-actions" style="
    text-align: right;
    justify-content: flex-start;
"><a href="{{ route("admin_check_authorize",["id"=>$meta->user->id]) }}"><span>نمایش</span></a>
                                 </div>
                        </td>
    ...
    justify-content: flex-start;
">
                                <a title="نمایش" href="{{ route("admin_check_authorize",["id"=>$meta->user->id]) }}">
                                                                <span>
