...
<style>
    ...
    .header-login {
        ...
        box-shadow: -4px 10px 24px rgba(26, 37, 49, 0.03);
        text-align: center;
        margin-bottom: 50px;
        padding: 16px;
    }.footer-login2 {
                                                ...
                                                jQuery.ajax({
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        if (statusSendCode == true) {
                                                            ...
                                                            $("#authForm").hide();
                                                            $(".statusAuth").text(`تایید هویت ورود به {{ env('APP_NAME') }}`)
                                                            ...
                                                            $('#check_code_register_back').click(function () {
                                                                ...
                                                                $(".statusAuth").text("ورود به {{ env('APP_NAME') }} ")
                                                                stopTimer();
            ...
            function startTimer(secends = 60) {
                ...
                var timer = setInterval(function () {
                    ...
                    if (secends <= 0) {
                        ...
                        btn_counter.html('ارسال مجدد کد')
