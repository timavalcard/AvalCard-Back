                            ...
                            <div class="woocommerce-MyAccount-content">
                                ...
                                <table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="woocommerce-orders-table__header woocommerce-orders-table__header-order-actions"><span class="nobr">نمایش</span></th>
                                    </tr>
                                    </thead>
                                    ...
                                    @foreach($orders as $order)
                                        <tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-cancelled order">
                                            ...
                                            <td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-order-actions" data-title="عملیات&zwnj;ها">
                                                <a href="{{ route("user.order",["id"=>$order->id]) }}" class="woocommerce-button button view">نمایش </a>													</td>
                                        </tr>
                                    @endforeach
