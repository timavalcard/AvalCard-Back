            ...
            <div class="checkout-received">
                <div class="row">
                    ...
                    <div class="col-md-2 ">
                        <img style="
    margin-bottom: -70px;
" class="w-100" data-src="{{ theme_asset("img/received.png") }}" alt="">
                    </div>
                    <div class="col-md-9">
                        <div class="checkout-received-title">
                            <strong>
                                سفارش شما با موفقیت ثبت شد.
                            </strong>
                        </div>
                        <div class="checkout-received-data">
                            <p>
                                کد سفارش: {{ $order->id }}
                            </p>
                            <p>
            ...
            <div class="hidi-title text-center">
                ...
                <span>
                  مروری بر سفارشات شما از هیدی لیدی
                </span>

            </div>

            <table class="received_table shop_table shop_table_responsive cart " cellspacing="0">
            ...
            @foreach($order->products_id as $parent2_cart_product)
                @foreach($parent2_cart_product as $parent_cart_product)
                    @php($cart_product=$products->where("id",$parent_cart_product["id"])->first())
                        ...
                        <td class="product-thumbnail">
                            ...
                            <div class="col-md-5 col-7">
                                <div class="product-name" data-title="محصول">
                                    <a href="{{ $cart_product->url }}">{{ $cart_product->title }}  × {{ $parent_cart_product["quantity"] }}
                                    </a>
