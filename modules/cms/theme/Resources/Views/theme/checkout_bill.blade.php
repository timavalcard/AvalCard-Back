...
@section("content")
    <div class="container">
        <div class="rows">
            ...
            <div class="hidi-title text-center">
                ...
                <span>
                  درگاه خود را انتخاب کنید و اگر کد تخفیفی دارید اعمال کنید.
                </span>
                ...
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="address-box-item-bottom">
                                <p>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.16">
                                            <path d="M1.5 5.5H14.5M1.5 6H14.5M3.5 9.5H7.5M3.5 11H5.5M3 13H13C13.3978 13 13.7794 12.842 14.0607 12.5607C14.342 12.2794 14.5 11.8978 14.5 11.5V4.5C14.5 4.10218 14.342 3.72064 14.0607 3.43934C13.7794 3.15804 13.3978 3 13 3H3C2.60218 3 2.22064 3.15804 1.93934 3.43934C1.65804 3.72064 1.5 4.10218 1.5 4.5V11.5C1.5 11.8978 1.65804 12.2794 1.93934 12.5607C2.22064 12.842 2.60218 13 3 13Z" stroke="#292929" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </g>
                                    </svg>
                                    امکان پرداخت با تمام کارت های عضو شتاب
                                </p>

                            </div>

                            <div id="order_gateway">
                                @foreach($gateways as $gateway_key=>$gateway)
                                    <div class="gateway_item @if($loop->index==0) active @endif" data-gateway="{{ $gateway_key }}">
                                        <img data-src="{{ config("payment.drivers.$gateway_key.img_src") }}" alt="">
                                        <strong>{{ $gateway["name"] }}</strong>
                                        <span>
                                            پرداخت با همه کارتهای شتاب
                                        </span>
                                    </div>
                                @endforeach
                                <input type="hidden" name="gateway" value="{{ array_key_first($gateways) }}" id="gateway">
                            </div>
                        ...
                        <div class="gateway-box-item">
                            ...
                            <div id="coupon_box">
                                <div class="coupon_box_content">
                                    <input type="text" name="coupon" id="coupon" placeholder="کوپن تخفیف خود را وارد کنید...">
                                    <button style="padding: 9px;" type="button" class="apply_coupon btn btn-sm button alt">ثبت کد</button>
                                </div>
                            </div>

                        </div>
                        @if($wallet)
                        <div class="gateway-box-item mt-4 d-flex justify-content-between align-items-center">
                            <div class="address-box-item-top">
                                <div class="address-box-item-top-right">
                                    <strong>
                                        پرداخت از کیف پول
                            ...
                            <div class="use_wallet">
                                @includeIf(config("theme.theme_cart_use_wallet_path"))
                    ...
                    <div class="col-md-4 mt-4 mt-md-0">
                        <div class="gateway-box-item mb-4">
                            <div class="address-box-item-top">
                                <div class="address-box-item-top-right">
                                    <svg class="ml-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_915_379)">
                                            <path d="M12 3L20 7.5V16.5L12 21L4 16.5V7.5L12 3Z" stroke="#292929" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12 12L20 7.5" stroke="#292929" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12 12V21" stroke="#292929" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12 12L4 7.5" stroke="#292929" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M8.25 5.25L15.75 9.375" stroke="#292929" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </g>
                                        <defs>
                            ...
                            <div class="address-box-item-bottom">
                                <p>
                                    این سفارش توسط
                                    <strong>
                                        {{ $selected_address["billing_first_name"] }}  {{ $selected_address["billing_last_name"] }}
                                    </strong>
                                    به آدرس
                                    <strong>
                        ...
                        @includeIf(config("theme.theme_cart_total_box_path"),["bill_page"=>true])
                    </div>
                    <div class="col-12">
                        <div class="checkout-box-btn">
                            <div>
                                <a href="/checkout/address" class="return_back">
    ...
    @push("js")
        <script>
            jQuery(".gateway_item").click(function(){
                jQuery(".gateway_item").removeClass("active");
                jQuery(this).addClass("active");
                var gateway=jQuery(this).data("gateway");
                jQuery("input#gateway").val(gateway)
            })
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(data.type==="success"){
                            jQuery("tr.cart-coupon").removeClass("d-none")
                            jQuery("tr.cart-coupon td").html(jQuery('#coupon').val())
                            if(data.delivery != null){
                                jQuery("tr.cart-discount td").html(data.delivery)

                            }
                            jQuery("tr.order-total td").html(data.amount)
                        }
