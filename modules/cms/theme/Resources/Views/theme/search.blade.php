...
@section("meta")
    ...
    <meta property="og:title" content="نتیجه جستجو : {{ request()->s }}">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:site_name" content="{{ get_site_title() }}">
    <meta name="twitter:title" content="نتیجه جستجو : {{ request()->s }}">
@endsection
            ...
            <div class="col-12">
                <div class="bread-crumb-box">
                    ...
                    <div class="bread-crumb-box-item current">
                        <a href="#">نتیجه جستجو : {{ request()->s }}</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3  d-none d-md-block">
                    <div class="filter-box mb-4">
                        ...
                        <div class="filter-item">
                            @foreach($data["categories"] as $all_category_item)
            ...
            <script>
                jQuery(document).ready(function ($){
                    $('.slider').each(function(e) {
                        ...
                        slider.slider({
                            range: true,
                            values: [{{ $data["cheapest_product"]?$data["cheapest_product"]->regular_price:0 }}, {{ $data["expensive_product"]?$data["expensive_product"]->regular_price:0 }}],
                            min: {{ $data["cheapest_product"]?$data["cheapest_product"]->regular_price:0 }},
                            step: 5,
                            minRange: 1000,
                            max: {{ $data["expensive_product"]?$data["expensive_product"]->regular_price:0 }},
                            create(event, ui) {
