...
Route::group(
    ...
    Route::group(get_information_for_admin_panel_route_group(),function ($router) {    $router->get('courses/{course}/lessons/create', 'LessonController@create')->name('lessons.create');
    ...
    Route::get("/lessons/{lesson}/buy", 'LessonController@buy')->name('lessons.buy')->middleware("auth");
