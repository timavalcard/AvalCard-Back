<x-admin-panel-layout>
    ...
    <div class="row no-gutters  ">
        <div class="col-7 bg-white padding-30 margin-left-10 margin-bottom-15 border-radius-3">
            ...
            <div class="table__box">
                <table class="table">
                    ...
                    @foreach($lessons as $lesson)
                        ...
                        <td class="status">
                            @if($lesson->status == \CMS\Course\Models\Lesson::STATUS_OPENED)
                        ...
                        <td>
                            @can(\CMS\RolePermissions\Models\Permission::PERMISSION_MANAGE_COURSES)
                                ...
                                @endif
                            @endcan
                            <a href="{{ route('lessons.edit', [$course->id, $lesson->id]) }}" class="item-edit mlg-15 " title="ویرایش"></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
        ...
        <div class="col-4">
            ...
            {{--<div class="col-12 bg-white margin-bottom-15 border-radius-3">
                ...
                <form action="" method="post" class="padding-30">
                    ...
                    <button class="btn btn-cafeamooz">اضافه کردن</button>
                </form>
