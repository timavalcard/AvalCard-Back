    ...
    <x-slot name="main">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-4">
                    <div class="col-sm-6">
                        <h3 class="m-0 text-dark">افزودن محصول</h3>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <form action="{{ route("admin_product_add") }}" method="post" class="w-100" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                        <input type="text" placeholder="نام محصول" name="title" value="{{old("title")}}">
                    </p>
                    <p>
                        ...
                        <div class="col-12 form-item">
                            ...
                            <div class="row">
                                ...
                                <ul class="admin-product-list-ul nav nav-tabs col-md-3 p-0" style="flex-direction: column" data-tabs="tabs">
                                    ...
                                    <li class="for-variable d-none"><a data-toggle="tab" href="#variable">متغیر ها</a></li>
                                    <li class="for-sample"><a data-toggle="tab" href="#anbar">انبار</a></li>
                                </ul>
                                ...
                                <div class="tab-content col-lg-9">
                                    <div id="asli" class="admin-product-list-content-item tab-pane fade in active show " >
                                        <div class="for-sample">
                                            ...
                                            <p class="mt-2">
                                                ...
                                                <input type="text" class="w-50 admin-input-price" name="price" value="{{  old("price")  }}">
                                            </p>
                                            <p class="mt-2">
                                                <label style="width: 23%">قیمت فروش فوق‌العاده  : </label>
                                                <input type="text" class="w-50 admin-input-price-offer" name="offer_price" value="{{  old("offer_price")  }}">
                                        ...
                                        <p class="mt-2">
                                            ...
                                            <input type="text" class="w-50 " name="buyer_count" value="{{  old("buyer_count")  }}">
                                        </p>
                                    </div>
                                    <div id="vizhegi" class="admin-product-list-content-item tab-pane fade in  " >
                                        ...
                                        <div class="vizhegi-items-box"></div>
                                    ...
                                    <div id="anbar" class="for-sample admin-product-list-content-item tab-pane fade in  " >
                                        <p>
                                            <input id="stock_manage" type="checkbox" name="manage_stock" @if(old("manage_stock")) checked @endif>
                                        ...
                                        <div class="manage-stock-number d-none ">
                                            ...
                                            <p>
                                                ...
                                                <input type="number" name="low_stock_amount" value="{{ old("low_stock_amount") }}">
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="admin-metabox-item metabox-close">
                        <div class="admin-metabox-item-title"><h5>توضیحات کوتاه محصول</h5>                        <span
                ...
                <div class="col-lg-3">
                    ...
                    <div class="admin-metabox-item metabox-close">
                        ...
                        <div class="col-12 form-item">
                            ...
                            <input type="number" name='affiliate_percent' min="0" max="100" class="mt-3" value="{{ old("affiliate_percent") }}"
                        ...
                        <div class="col-12 form-item ">
                            <ul class="mt-3 category-list">
                                @foreach($brands as $brand)
                                    <li>
                                        <input type="checkbox" name="product_brand[]" value="{{$brand->id}}">
                    ...
                    <div class="admin-metabox-item metabox-close">
                        ...
                        <div class="col-12 form-item mt-3">
                            <button class="open-admin-media-frame open-admin-media-frame-gallery btn-blue">انتخاب عکس</button>
