                ...
                <div class="col-lg-9">
                    ...
                    <p class="mt-2">
                        ...
                        @if(isset($product->category[0]))
                            <a target="_blank" href="https://avalcard.com/buy-deliver-iran/{{$product->category[0]->slug}}/{{$product->slug}}" class="btn text-white btn-primary mr-2">نمایش در سایت</a>
                        @endif
                    </p>
                                ...
                                <div class="tab-content col-lg-9">
                                    <div id="asli" class="admin-product-list-content-item tab-pane fade in active show " >
                                        <div class="for-sample @if($product->type == "variable") d-none @endif">
                                            ...
                                            <p>
                                                <input type="text" name="send_price" class="mt-3" value="{{ $product->send_price }}"
                                                       placeholder="هزینه ارسال به ازای هر کیلوگرم ( بر حسب ارز انتخاب شده در بالا )">
                                                <span class="description">هزینه ارسال سایر واحد های وزنی ( گرم - اونس - پوند ) بر اساس کیلوگرم محاسبه خواهد شد</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
