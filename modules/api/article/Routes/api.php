...
Route::group(["namespace"=>"API\Article\Http\Controllers","middleware"=>"web"],function(){
    ...
    Route::group(get_information_for_api_route_group(),function (){
        ...
        Route::post("/search","ArticleController@search")->name("api.search_article");
        ...
        Route::middleware('auth:sanctum')->post("/add-comment/","ArticleController@add_comment")->name("api.add_comment");
    });
