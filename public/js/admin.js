...
function toastMessage() {
  var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "عملیات موفقیت امیز بوذ";
  var heading = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "موفق";
  var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "success";
  var loaderBg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "#90e084";
  jQuery.toast({
    text: text,
...
$(document).ready(function () {
  ...
  if ($(".admin-frame-media-select")) {
    ...
    if ($(".add-menu-boxs ul")) {
      sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(document.querySelector(".add-menu-boxs ul"), {
        animation: 150,
    ...
    if ($(".menu-add-item-box")) {
      $(".menu-add-item-box").click(function (e) {
        ...
        checked.forEach(function (e) {
          ...
          parentUl.insertAdjacentHTML("beforeend", "\n            <li class=\"add-menu-box\">\n                        <div class=\"add-menu-box-bottom-top\">\n                            <div class=\"add-menu-box-name\">\n                                ".concat(parent.querySelector("label").textContent, "\n                            </div>\n                            <div class=\"add-menu-box-open-btn\">\n                                <i class=\"fa fa-angle-down\"></i>\n                            </div>\n                        </div>\n                        <div class=\"add-menu-box-bottom-content\">\n                        <input type=\"hidden\" name=\"menu_id[]\" value=\"").concat(parent.querySelector(".menu-checkbox").value, "\">\n                            <p class=\"form-row\">\n                                <label>\u0646\u0627\u0645 :</label>\n                                <input type=\"text\" name=\"menu_name[]\" class=\"menu-name-input\" placeholder=\"\u0646\u0627\u0645\" value=\" ").concat(parent.querySelector("label").textContent, "\">\n                            </p>\n                            <p class=\"form-row\">\n                                <label>\u0644\u06CC\u0646\u06A9 :</label>\n                                <input type=\"text\" name=\"menu_link[]\" placeholder=\"\u0644\u06CC\u0646\u06A9\" value=\"").concat(parent.querySelector(".menu-link").value, "\">\n                            </p>\n                            <div class=\"form-row\">\n                            <button class=\"btn btn-danger delete-admin-item btn-sm\">\u062D\u0630\u0641</button>\n</div>\n                        </div>\n                    </li>\n            "));
...
module.exports = __webpack_require__(/*! D:\web\xampp\htdocs\laravel_admin_panel\resources\js\admin.js */"./resources/js/admin.js");
